                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6 mb-5 mb-md-0">
                                <div class="contact-info">
                                    <div class="mb-4">
                                        ...
                                        <h3 class="info-title link-title fs-18 mb-3 font-weight-600 position-relative"><?php echo html_escape($address->title);?></h3>
                                        <address class="mb-4">
                                    ...
                                    <div class="mb-4">
                                        <h3 class="info-title link-title fs-18 mb-3 font-weight-600 position-relative"><?php echo html_escape($phoneapp->title);?></h3>
                                       <?php echo html_escape($phoneapp->subtitle);?>
                                    </div>
                                    <!-- /.End of phone -->
                                    <div class="mb-4">
                                    	<?php $emails=$this->db->select('*')->from('tbl_slider')->where('slid',74)->get()->row();?>
                                        <h3 class="info-title link-title fs-18 mb-3 font-weight-600 position-relative"><?php echo html_escape($emails->title);?></h3>
                            ...
                            <div class="col-md-6">
                                ...
                                <?php echo form_open('sendemail');?>
                                    ...
                                    <div class="form-group">
                                        <input type="email" class="form-control" id="email" name="email" placeholder="hello@domain.com" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" id="comments" rows="5" name="comments" placeholder="Tell us what we can help you with!"></textarea>
                                    </div>
                                    <!-- Submit -->
