            ...
            <div class="section">
                <div class="container">
                    ...
                    foreach($roominfo as $singleroom){
                        ...
                        $facilityinfo=$this->db->select("roomfacilitydetails.facilitytitle,roomfaility_ref_accomodation.*")->from('roomfaility_ref_accomodation')->join('roomfacilitydetails','roomfacilitydetails.facilityid=roomfaility_ref_accomodation.facilityid','left')->where('roomfaility_ref_accomodation.room_id',$singleroom->roomid)->get()->result();
                                    ...
                                    <div class="d-md-flex justify-content-between">
                                        <div class="item-overview">
                                            ...
                                            <div class="room-content d-flex align-items-center mb-3">
                                                ...
                                                <?php foreach($facility as $list){ ?>
                                                <div class="room-bed-config mr-2" data-toggle="tooltip" data-placement="top" title="<?php echo html_escape($list->title);?>">
                                                    <!--bed-->
