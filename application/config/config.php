...
$config['csrf_exclude_uris'] = array('dashboard/autoupdate/update', 'dashboard/autoupdate/updatenow','hotel/successful/[0-9]+/[0-9]+','hotel/fail/[0-9]+','hotel/cancilorder/[0-9]+');
