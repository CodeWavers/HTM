    ...
    <div class="col-sm-12 col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input name="room_type" class="form-control" type="text" readonly="readonly"
                               value="<?php echo html_escape($room_name) ?>">
                    </div>
                </div>

                <div class="form-group row">
                    <label for="no_of_people" class="col-sm-4 col-form-label"><?php echo display('no_of_people') ?>
                        <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row " id="change_room" style="display: none">
                    <label for="select_room_no" class="col-sm-4 col-form-label">Change Room</label>
                    <div class="col-sm-8">
                        <select name="change_room[]" multiple="multiple" class="selectpicker form-control"
                ...
                <?php if (!empty($intinfo->room_no)){ ?>
                    <div class="form-group row">
                        <label for="select_room_no"
                               class="col-sm-4 col-form-label"><?php echo display('select_room_no') ?> <span
                                    class="text-danger">*</span></label>
                        <div class="col-sm-6">
                            <input name="room_no" autocomplete="off" class="form-control" type="text"
                                   readonly="readonly" placeholder="<?php echo display('select_room_no') ?>"
                                   value="<?php echo html_escape((!empty($room_no) ? $room_no : null)) ?>"
                                   id="select_room_no">
                        ...
                        <div class=" col-sm-2">
                            <a href="#" id="change_btn" class=" btn-sm btn btn-danger"><i
            ...
            <?php }else{ ?>
                ...
                <div class="form-group row">
                    <label for="no_of_people" class="col-sm-4 col-form-label"><?php echo display('select_room_no') ?>
                        <span class="text-danger">*</span></label>
                    <div class="col-sm-8">
                        <select name="slroomno[]" multiple="multiple" class="selectpicker form-control"
                                data-live-search="true" id="slroomno">
                            <option value="" disabled><?php echo display('select_room_no') ?></option>
                            <?php $allroomno = explode(',', $freeroom);
                            foreach ($allroomno as $sroom) {
                                ?>
                ...
                <div class="form-group row">
                    <label for="check_in" class="col-sm-4 col-form-label"><?php echo display('check_in') ?> <span
                                class="text-danger">*</span></label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row">
                    <label for="check_out" class="col-sm-4 col-form-label"><?php echo display('check_out') ?> <span
                                class="text-danger">*</span></label>
                    <div class="col-sm-8">
