                    ...
                    <table class="datatable table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <a href="<?php echo base_url("accounts/accounts/isactive/".html_escape($approve->VNo)."/active") ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-info btn-sm text-white" data-toggle="tooltip" data-placement="right" title="Inactive"><?php echo display('approved')?></a>
