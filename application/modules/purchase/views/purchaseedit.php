<div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="card">
                <div class="card-header"><h4><?php echo display('purchase_edit') ?></h4></div>
                <div class="card-body">
                    ...
                    <div class="row">
						...
						echo form_dropdown('suplierid',$supplier,(!empty($purchaseinfo->suplierID)?$purchaseinfo->suplierID:null),'class="form-control"  id="suplierid"') ?>
                                    ...
                                    <div class="col-sm-3">
                                        <a href="<?php echo base_url("setting/supplierlist/index") ?>"><?php echo display('add_supplier') ?></a>
                                    </div>
                                </div> 
                            </div>
                             <div class="col-sm-5">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" tabindex="3" class="form-control" name="invoice_no" value="<?php echo html_escape($purchaseinfo->invoiceid);?>" placeholder="Invoice No" id="invoice_no" required="">
                                    </div>
                                </div>
                            </div>
                        </div>
                    <div class="row mt-2">
                            <div class="col-sm-7">
                            <div class="form-group row">
                                    <label for="date" class="col-sm-3 col-form-label"><?php echo display('purchase_date') ?><i class="text-danger">*</i>
                                    </label>
                                    <div class="col-sm-3">
                                 <input type="text" class="form-control datepickers" name="purchase_date" value="<?php echo html_escape($purchasedate);?>" required="" tabindex="2">
                                    </div>
                                     <label for="date" class="col-sm-3 col-form-label"><?php echo display('expire_date') ?> <i class="text-danger">*</i></label>
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control datepickers" name="expire_date" data-date-format="mm/dd/yyyy" value="<?php echo html_escape($expiredatedate);?>" id="expire_date" required="" tabindex="2" readonly="readonly">
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-5">
                               <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                        <textarea class="form-control" tabindex="4" id="adress" name="purchase_details" placeholder=" Details" rows="1"><?php echo html_escape($purchaseinfo->details);?></textarea>
                                    </div>
                                </div> 
                            </div>
                        </div>
                     <table class="table table-bordered table-hover" id="purchaseTable">
                                <thead>
                                     <tr>
                                            ...
                                            <th class="text-center"><?php echo display('defaultrate') ?><i class="text-danger">*</i></th>
								...
								foreach($iteminfo as $item){
                                   ...
                                   <input type="hidden" class="sl" value="<?php echo $i;?>">
                                       ...
                                       <td class="wt">
                                            ...
                                            <td class="text-right">
                                                <input type="number" min="1" name="product_quantity[]" id="cartoon_<?php echo $i;?>" class="form-control text-right store_cal_1" onkeyup="calculate_store(<?php echo $i;?>);" onchange="calculate_store(<?php echo $i;?>);" placeholder="0.00" value="<?php echo html_escape($item->quantity);?>" min="0" tabindex="6" required>
                                            </td>
                                            <td class="test">
                                                <input type="text" name="product_rate[]" onkeyup="calculate_store(<?php echo $i;?>);" onchange="calculate_store(<?php echo $i;?>);" id="product_rate_<?php echo $i;?>" class="form-control product_rate_<?php echo $i;?> text-right" placeholder="0.00" value="<?php echo html_escape($item->price);?>" min="0" tabindex="7">
                                            </td>
                                           

                                            <td class="text-right">
                                                <input class="form-control total_price text-right" type="text" name="total_price[]" id="total_price_<?php echo $i;?>" value="<?php echo html_escape($item->totalprice);?>" readonly="readonly">
                                            </td>
                                            <td>
                                                <button class="btn btn-danger red text_align_right" type="button" value="Delete" onclick="deletePurchaseRow(this)" tabindex="8"><?php echo display('delete')?></button>
                                            </td>
                                    </tr>
                                    <?php } ?>
                                    <?php } ?>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <input type="text" id="grandTotal" class="text-right form-control" name="grand_total_price" value="<?php echo html_escape($purchaseinfo->total_price);?>" readonly="readonly">
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
