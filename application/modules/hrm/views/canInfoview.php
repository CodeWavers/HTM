                                            ...
                                            <tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>">
                                                ...
                                                <td class="center">
                                                    ...
                                                    <?php if ($this->permission->method('hrm', 'delete')->access()) : ?>
                                                        <a href="<?php echo base_url("hrm/Candidate/delete_canInfo/" . html_escape($que->can_id)) ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="ti-trash"></i></a>
                                                    <?php endif; ?>
