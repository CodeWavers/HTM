                            ...
                            <?php foreach ($loanss as $que) { ?>
                                ...
                                <?php if($this->permission->method('hrm','update')->access()): ?> 
                                    ...
                                    <?php if($this->permission->method('hrm','delete')->access()): ?> 
                                        <a href="<?php echo base_url("hrm/loan-installment-delete/".html_escape($que->loan_inst_id)) ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="ti-trash"></i></a> 
                                        <?php endif; ?>
                                    </td>
                                </tr>
                                <?php $sl++; ?>
