...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        <div class="card"> 
			<div class="card-header"><h4><?php echo display('report_view') ?><small class="float-right">
            ...
            <div class="card">
                ...
                <?php echo form_open('hrm/attend-report-list','name="myForm"') ?>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="employee_id" class="form-control" type="text" placeholder="<?php
                                 ...
                                 echo display('employee_id_se') ?>"  id="employee_id" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="date" class="col-sm-3 col-form-label"><?php echo display('start_date') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input name="s_date" class="datepickers form-control" type="text" value="<?php echo date('Y-m-d'); ?>" placeholder="<?php
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="e_date" value="<?php echo date('Y-m-d') ?>" class="datepickers form-control" type="text" placeholder="<?php  
            ...
            <div class="card">
                ...
                <?php echo form_open('hrm/attendance-report-list') ?>
                        ...
                        <div class="form-group row">
                            <label for="date" class="col-sm-3 col-form-label"><?php echo display('start_date') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input name="start_date" value="<?php echo date('Y-m-d') ?>" class="datepickers form-control" type="text" placeholder="<?php
                        ...
                        <div class="form-group row">
                            <label for="end_date" class="col-sm-3 col-form-label"><?php echo display('end_date') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                                <input name="end_date" value="<?php echo date('Y-m-d') ?>" class="datepickers form-control" type="text" placeholder="<?php  
            ...
            <div class="card">
                ...
                <?php echo form_open('hrm/date-time-report-list','name="myForm"') ?>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="date" value="<?php echo date('Y-m-d') ?>" class="datepickers form-control " type="text" placeholder="<?php
        
                                 echo display('date') ?>"  id="c_date" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="s_time" class="col-sm-3 col-form-label"><?php echo display('s_time') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group row">
                            <label for="e_time" class="col-sm-3 col-form-label"><?php echo display('e_time') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-9">
