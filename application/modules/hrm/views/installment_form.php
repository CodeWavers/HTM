   ...
   <div class="row">
        <div class="col-sm-12 col-md-12">
            ...
            <?php echo form_open('hrm/loan-installment') ?>
                        ...
                        <div class="form-group row">
                            <label for="loan_id" class="col-sm-4 col-form-label"><?php echo display('loan_id') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                                 <select name="loan_id" class="form-control" onchange="SelectToname(this.value),SelectAuto(this.value)" id="loan_id"></select>


                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="installment_amount" class="col-sm-4 col-form-label"><?php echo display('installment_amount') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="payment" class="col-sm-4 col-form-label"><?php echo display('payment') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            <label for="date" class="col-sm-4 col-form-label"><?php echo display('date') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                                <input type="text" name="date" class="datepickers form-control"  placeholder="<?php echo display('date') ?>" >
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="received_by" class="col-sm-4 col-form-label"><?php echo display('received_by') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                                 <?php echo form_dropdown('received_by',$gndloan,null, 'class="form-control"  id="received_by"') ?>
                            </div>
                        </div>   
                         <div class="form-group row">
                            <label for="installment_no" class="col-sm-4 col-form-label"><?php echo display('installment_no') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-8">
    ...
    <div class="col-sm-12">
        ...
        <div class="card"> 
			<div class="card-header"><h4><?php echo display('loan_installment') ?><small class="float-right">  <?php if($this->permission->method('hrm','create')->access()): ?>
...
<a href="<?php echo base_url();?>hrm/manage-loan-installment" class="btn btn-primary mb-2"><?php echo display('manage_installment')?></a>
