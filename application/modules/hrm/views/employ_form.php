                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_dropdown('country', $allcountry, (!empty($emp->country)?$emp->country:""), ' class="form-control" onchange="getstate()" id="country"') ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                ...
                <div class="col-sm-12 col-md-11 col-lg-12 col-xl-12">
                  ...
                  ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="work_hour"><?php echo display('rate')?> <span class="text-danger">*</span></label>
                                        <div class="input__holder2">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="ssn"><?php echo display('ssn')?> <span class="text-danger">*</span></label>
                                        <div class="input__holder2">
