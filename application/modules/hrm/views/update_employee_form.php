                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_dropdown('country', $allcountry, (!empty($data->country)?$data->country:""), ' class="form-control" onchange="getstate()" id="country"') ?>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="ssn"><?php echo display('ssn')?> <sup
                                                class="color-red text-danger">*</sup></label>
