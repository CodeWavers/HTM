                                ...
                                <?php foreach ($shortlist as $que) { ?>
                                    <tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>">
                                        ...
                                        <td class="center">
                                            ...
                                            <a href="<?php echo base_url("hrm/shortlist-delete/" . html_escape($que->can_short_id)) ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="ti-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php $sl++; ?>
                                <?php } ?>
