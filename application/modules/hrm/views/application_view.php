                                ...
                                <td><?php echo html_escape($row->leave_aprv_end_date); ?></td>                            
                                   <td class="center">
                                    ...
                                    <?php if($this->permission->method('hrm','delete')->access()): ?>  
                                        <a href="<?php echo base_url("hrm/leave-application-delete/".html_escape($row->leave_appl_id)) ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="ti-close"></i></a>
                                         <?php endif; ?> 
                                    </td>
                                </tr>
                                <?php $sl++; ?>
