                                ...
                                <td><?php echo html_escape($row->alt_emg_w_phone); ?></td>
                                    ...
                                    <td class="center">
                                      ...
                                      <?php if($row->employee_id=='E4Y91CAX'){?>
										...
										?>
                                          <a href="<?php echo base_url("hrm/Employees/delete_employhistory/".html_escape($row->employee_id)) ?>" class="btn btn-xs btn-danger" onclick="return confirm('<?php echo display('are_you_sure') ?>') "><i class="ti-trash"></i></a>
                                        <?php } ?>
