   <div class="row">
        <div class="col-sm-12 col-md-12">
            ...
            <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                                    <input name="division_name" class="form-control" type="text" placeholder="<?php echo display('division_name') ?>" id="division_name" value="<?php echo html_escape((!empty($division->department_name)?$division->department_name:null)) ?>" required >
                        </div>
                    </div> 
                    <div class="form-group row">
