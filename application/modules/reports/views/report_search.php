                                ...
                                <h4>
                                    ...
                                    <small class="float-right">
                                        <input type="button" class="btn btn-info button-print text-white"
                                            name="btnPrint" id="btnPrint" value="Print" onclick="printContent('printArea')" />
                                    </small>
                                </h4>
                            </div>
                            <div class="card-body">
                       ...
                       //    echo '<pre>';print_r($room_type);exit();
                            ...
                            ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($book->bookingstatus ==1) {
                                                    echo 'Refund';
                                                }else{ ?>
                                                <?php if($book->total_price>$book->paid_amount){echo display('pending');}else{echo display('complete');}?>
                                                <?php } ?>
