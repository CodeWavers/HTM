                ...
                <div class="panel-body">
                    ...
                    <?php echo form_hidden('id', (!empty($intinfo->id)?$intinfo->id:null)) ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input name="ingredientname" class="form-control" type="text" placeholder="<?php echo display('ingredient_name') ?>" id="unitname" value="<?php echo html_escape((!empty($intinfo->product_name)?$intinfo->product_name:null)) ?>">
                            </div>
                        </div>
						<div class="form-group row">
