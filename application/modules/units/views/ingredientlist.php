            ...
            <div class="card">
                ...
                <?php echo form_open('units/products/create') ?>
                    <?php echo form_hidden('id', (!empty($intinfo->id)?$intinfo->id:null)) ?>
                        ...
                        <label for="lastname" class="col-sm-4 col-form-label"><?php echo display('unit_name') ?> <span class="text-danger">*</span></label>
                        ...
                        <div class="form-group row">
                            <label for="unit_name" class="col-sm-4 col-form-label"><?php echo display('ingredient_name') ?> <span class="text-danger">*</span></label>
                            <div class="col-sm-8">
...
<div class="row">
    ...
    <div class="col-sm-12">
        ...
        <div class="card"> 
<div class="card-header"><h4><?php echo display('product_list')?><small class="float-right"><?php if($this->permission->method('units','create')->access()): ?>
                                ...
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                   ...
                                   <td class="center">
                                    <?php if($this->permission->method('units','update')->access()): ?>
                                        ...
                                        <a onclick="editingredient('<?php echo html_escape($ingredient->id); ?>')" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil text-white" aria-hidden="true"></i></a> 
                                         <?php endif; 
										 if($this->permission->method('units','delete')->access()): ?>
                                        <a href="<?php echo base_url("units/product-delete/".html_escape($ingredient->id)) ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Delete "><i class="ti-trash" aria-hidden="true"></i></a> 
                                         <?php endif; ?>
                                    </td>
