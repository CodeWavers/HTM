                ...
                <?php echo form_open('payment_setting/paymentmethod/create') ?>
                    <?php echo form_hidden('payment_method_id', (!empty($intinfo->payment_method_id)?$intinfo->payment_method_id:null)) ?>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input name="payment" class="form-control" type="text" placeholder="<?php echo display('payment_name') ?>" id="unitname" value="">
                            </div>
                        </div>
						<div class="form-group row">
                            ...
                            <?php foreach ($paymentlist as $payment) { ?>
                                <tr class="<?php echo ($sl & 1)?"odd gradeX":"even gradeC" ?>">
                                   ...
                                   <td class="center">
                                    ...
                                    <input name="url" type="hidden" id="url_<?php echo html_escape($payment->payment_method_id); ?>" value="<?php echo base_url("payment_setting/paymentmethod/updateintfrm") ?>" />
                                        <a onclick="editinfo('<?php echo html_escape($payment->payment_method_id); ?>')" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil text-white" aria-hidden="true"></i></a> 
                                         <?php endif; 
										  ?>
                                    </td>
