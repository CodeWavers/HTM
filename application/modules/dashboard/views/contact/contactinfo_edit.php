...
<div class="form-group row">
    <label for="title" class="col-sm-3 col-form-label"><?php echo "Title" ?> <span class="text-danger">*</span></label>
    <div class="col-sm-9">
        <input name="width" id="contact_width" class="form-control" type="text" placeholder="<?php echo "title" ?>"
