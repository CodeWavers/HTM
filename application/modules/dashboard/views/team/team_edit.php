...
<div class="form-group row">
    <label for="title" class="col-sm-4 col-form-label"><?php echo "Name" ?> </label>
    <div class="col-sm-8">
...
<div class="form-group row">
    <label for="title" class="col-sm-4 col-form-label"><?php echo "image Size" ?> <span
...
<div class="form-group row">
    <label for="subtitle" class="col-sm-4 col-form-label"><?php echo "Position" ?> </label>
    <div class="col-sm-8">
...
<div class="form-group row">
    <label for="link1" class="col-sm-4 col-form-label"><?php echo "Image Text" ?> </label>
    <div class="col-sm-8">
        <input name="link1" class="form-control" type="text" placeholder="<?php echo "Image Text" ?>"
            value="<?php echo html_escape((!empty($intinfo->slink) ? $intinfo->slink : null)) ?>" id="url">
    </div>
</div>
<div class="form-group row">
    <label for="link1" class="col-sm-4 col-form-label"><?php echo "Facebook" ?> </label>
    <div class="col-sm-8">
        <input name="link1" class="form-control" type="text" placeholder="<?php echo "Facebook" ?>"
            value="<?php echo html_escape((!empty($intinfo->link1) ? $intinfo->link1 : null)) ?>" id="link1">
    </div>
</div>
<div class="form-group row">
    <label for="link2" class="col-sm-4 col-form-label"><?php echo "Twitter" ?> </label>
    <div class="col-sm-8">
        <input name="link2" class="form-control" type="text" placeholder="<?php echo "Twitter" ?>"
            value="<?php echo html_escape((!empty($intinfo->link2) ? $intinfo->link2 : null)) ?>" id="link2">
    </div>
</div>
<div class="form-group row">
    <label for="link3" class="col-sm-4 col-form-label"><?php echo "Instragram" ?> </label>
    <div class="col-sm-8">
        <input name="link3" class="form-control" type="text" placeholder="<?php echo "Instragram" ?>"
...
<div class="form-group row">
    ...
    <div class="col-sm-8 customesl">
        <select name="status" id="status" class="form-control">
            <option value="" selected="selected"><?php echo display('select_option') ?></option>
            <option value="1" <?php if (!empty($intinfo)) {
                                    if ($intinfo->status == 1) {
                                        echo "Selected";
                                    }
                                } ?>>
                <?php echo display('active') ?></option>
            <option value="0" <?php if (!empty($intinfo)) {
                                    if ($intinfo->status == 0) {
                                        echo "Selected";
                                    }
                                } ?>>
