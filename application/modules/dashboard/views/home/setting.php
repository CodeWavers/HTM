    ...
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="storevat" class="col-sm-3 col-form-label"><?php echo "VAT Setting(%)"; ?></label>
                    <div class="col-sm-6">
                        <input name="storevat" type="text" class="form-control" id="storevat"
                            placeholder="<?php echo "VAT"; ?>" value="<?php echo html_escape($setting->vat) ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="storevat" class="col-sm-3 col-form-label"><?php echo "Service Charge(%)"; ?></label>
                    <div class="col-sm-6">
                        <input name="scharge" type="text" class="form-control" id="scharge"
                            placeholder="<?php echo "Service Charge"; ?>"
                            value="<?php echo html_escape($setting->servicecharge) ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="storevat" class="col-sm-3 col-form-label"><?php echo "Country"; ?></label>
                    <div class="col-sm-6">
                        <input name="country" type="text" class="form-control" id="country"
                            placeholder="<?php echo "Country"; ?>" value="<?php echo html_escape($setting->country) ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="storekey" class="col-sm-3 col-form-label"><?php echo "Map Key"; ?></label>
                    <div class="col-sm-6">
                        <input name="map_key" type="text" class="form-control" id="map_key"
                            placeholder="<?php echo "Map Key"; ?>" value="<?php echo html_escape($setting->map_key) ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="storelatitude" class="col-sm-3 col-form-label"><?php echo "Latitude"; ?></label>
                    <div class="col-sm-6">
                        <input name="latitude" type="text" class="form-control" id="latitude"
                            placeholder="<?php echo "Latitude "; ?>"
                            value="<?php echo html_escape($setting->latitude) ?>" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="storelongitude" class="col-sm-3 col-form-label"><?php echo "Longitude"; ?></label>
                    <div class="col-sm-6">
                        <input name="longitude" type="text" class="form-control" id="longitude"
                            placeholder="<?php echo "Longitude "; ?>"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <?php echo form_dropdown('site_align', array('LTR' => display('left_to_right'), 'RTL' => display('right_to_left')) ,$setting->site_align, 'class="selectpicker form-control" data-live-search="true" id="site_align"') ?>
                    </div>
                </div>

                <div class="form-group row">
                    <label for="pricetxt" class="col-sm-3 col-form-label"><?php echo "Price Text";?></label>
                    <div class="col-sm-6">
                        <textarea name="pricetxt" class="form-control" placeholder="Price Text" maxlength="140"
                            rows="7"><?php echo html_escape($setting->pricetxt) ?></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="power_text" class="col-sm-3 col-form-label"><?php echo "Powered By Text";?></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <textarea name="footer_text" class="form-control" placeholder="Footer Text" maxlength="140"
