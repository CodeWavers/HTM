                            ...
                            <ul class="nav nav-pills" id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" onclick="getcompanies()" id="v-pills-companies-tab"
                                        ...
                                        aria-selected="false"><?php echo "Brand Logo"; ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="getteammembers()" id="v-pills-teammembers-tab"
                                        ...
                                        aria-selected="false"><?php echo "Team Members"; ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="getvisitors()" id="v-pills-visitor-tab"
                                        ...
                                        aria-selected="false"><?php echo "Counter"; ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="getteamgallery()" id="v-pills-teamgallery-tab"
                                        ...
                                        aria-selected="false"><?php echo "Team Gallery"; ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="getcontactinfo()" id="v-pills-contactinfo-tab"
                                        ...
                                        aria-selected="false"><?php echo "Contact Info"; ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="getgallery()" id="v-pills-gallery-tab"
                                        ...
                                        aria-selected="false"><?php echo "Gallery"; ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="getslider()" id="v-pills-slider-tab" data-toggle="pill"
                                        ...
                                        aria-selected="false"><?php echo "Slider"; ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="getpromise()" id="v-pills-promise-tab"
                                        ...
                                        aria-selected="false"><?php echo "Home Section 1"; ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="gethomeabout()" id="v-pills-homeabout-tab"
                                        ...
                                        aria-selected="false"><?php echo "Home Section 2"; ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="gettopoffer()" id="v-pills-topoffer-tab"
                                        ...
                                        aria-selected="false"><?php echo "Home Section 3"; ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="getblogoffer()" id="v-pills-blogoffer-tab"
                                        ...
                                        aria-selected="false"><?php echo "Home Section 4"; ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="getroomfeature()" id="v-pills-roomfeature-tab"
                                        ...
                                        aria-selected="false"><?php echo "Room Feature"; ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="getcheckout()" id="v-pills-checkout-tab"
                                        ...
                                        aria-selected="false"><?php echo "Checkout"; ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" onclick="getfooter()" id="v-pills-footer-tab" data-toggle="pill"
                                        ...
                                        aria-selected="false"><?php echo "Footer"; ?></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            <div class="tab-pane fade show active" id="v-pills-user" role="tabpanel"
                                ...
                                <div class="form-group row">
                                    <label for="firstname" class="col-sm-2"><?php echo display('firstname') ?> <i
                                ...
                                <div class="form-group row">
                                    <label for="lastname" class="col-sm-2"><?php echo display('lastname') ?> <i
                                            class="text-danger"> * </i></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="email" class="col-sm-2"><?php echo display('email') ?> <i
                                            class="text-danger"> * </i></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="password" class="col-sm-2"><?php echo display('password') ?> <i
                                            class="text-danger"> * </i></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row">
                                    <label for="image" class="col-sm-2"><?php echo display('image') ?><i
                                            class="text-danger"> * </i></label>
                                    <div class="col-sm-9">
                                        <div>
                            ...
                            <div class="tab-pane fade" id="v-pills-gallery" role="tabpanel"
                                ...
                                <h4><?php echo "Add Gallery" ?></h4>
                                <br>
                                <div class="form-group row">
                                    <label for="name" class="col-sm-2"><?php echo display('name') ?><span
                                ...
                                <div class="form-group row">
                                    <label for="title" class="col-sm-2"><?php echo "Image Size" ?> <span
                                            class="text-danger">*</span></label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group row">
                                    <label for="mobile"
                                        class="col-sm-2 col-form-label"><?php echo display('image') ?><span
                                            class="text-danger">*</span>
                                    </label>
                                    <div class="col-sm-9">
                            ...
                            <div class="tab-pane fade" id="v-pills-slider" role="tabpanel"
                                ...
                                <h4><?php echo "Add Slider Image" ?></h4>
                                <br>
                                <div class="form-group row">
                                    <label for="title" class="col-sm-2"><?php echo "Image Size" ?> <span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="file" accept="image/*" id="spicture" name="picture"><a
                                            class="cattooltipsimg" data-toggle="tooltip" data-placement="top"
                                            title="Use only .jpg,.jpeg,.gif and .png Images with Size: 1920X902"><i
                                                class="fa fa-question-circle" aria-hidden="true"></i></a>
                                    </div>
