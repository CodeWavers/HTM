                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <small id="fileHelp" class="text-muted"><img src="<?php echo html_escape(base_url(!empty($intinfo->room_imagename)?$intinfo->room_imagename:'assets/img/room-setting/room_images.png')); ?>" id="output" class="img-thumbnail height_150_width_200px" required/>
                                            </small>
