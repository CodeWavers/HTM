        ...
        <div class="card-header">
            <h4><?php echo display('room_list') ?> <small class="float-right">
                    <button type="button" class="btn btn-primary btn-md mb-2" data-target="#add0" data-toggle="modal"><i class="ti-plus" aria-hidden="true"></i>
                        <?php echo display('add_new') ?></button>&nbsp;<a href="<?php echo base_url("room_setting/assign-room") ?>" class="btn btn-primary btn-md mb-2"><?php echo display('assign_room') ?></a>&nbsp;<a href="<?php echo base_url("room_setting/assign-room-offer") ?>" class="btn btn-primary btn-md mb-2"><?php echo display('assign_roomoffer') ?></a>&nbsp;<a href="<?php echo base_url("room_setting/assign-room-facilities") ?>" class="btn btn-primary btn-md mb-2"><?php echo display('assign_facilities') ?></a></small></h4>
        </div>
    <?php endif; ?>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="roomtype" autocomplete="off" class="form-control" type="text" placeholder="<?php echo display('room_name') ?>" id="roomtype" value="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="child_limit" autocomplete="off" class="form-control" type="number" placeholder="<?php echo display('child_limit') ?>" id="child_limit" value="">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="number_of_star" class="form-control" type="number" placeholder="<?php echo display('number_of_star') ?>" id="number_of_star" onkeyup="starcheck()">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="roomdescription" cols="35" rows="3" placeholder="<?php echo display('roomdescription') ?>"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <textarea name="reservecondition" cols="35" rows="3" placeholder="<?php echo display('reserve_condition') ?>"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <tr class="<?php echo ($sl & 1) ? "odd gradeX" : "even gradeC" ?>">
                                        ...
                                        <td class="center">
                                            <?php if ($this->permission->method('room_setting', 'update')->access()) : ?>
                                                <input name="url" type="hidden" id="url_<?php echo html_escape($rateplan->roomid); ?>" value="<?php echo base_url("room_setting/room_details/updateintfrm") ?>" />
                                                <a onclick="editinforoom('<?php echo html_escape($rateplan->roomid); ?>')" class="btn btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="Update"><i class="ti-pencil-alt text-white" aria-hidden="true"></i></a>
                                            <?php endif;
                                            if ($this->permission->method('room_setting', 'delete')->access()) : ?>
                                                <a href="<?php echo base_url("room_setting/room-delete/" . html_escape($rateplan->roomid)) ?>" onclick="return confirm('<?php echo display("are_you_sure") ?>')" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="right" title="Delete "><i class="ti-trash"></i></a>
                                            <?php endif; ?>
                                        </td>
