...
(1, '98 Green Road, Farmgate, Dhaka-1215.', 'smartsoftwaret@gmail.com', '078965241369', '', '', '', '', 'Â© 2021 All Right Reserved by Xian Hotel. Developed by BdTask Ltd. \r\n');
...
(2, 'Xain Hotel', 'Resort & Spa', 'United States, America', 'atrgworld@gmail.com', '00923244796787', '', '', '', 2, 7, 'Pakistan', 'AIzaSyB-EEPxbay_aFpp3jcFXpjyPQcVQUJ2pp0', 23.8311, 90.4243, 2, 'english', 'Europe/London', '12:00:00', '10:00:00', '', 'LTR', 'The crossed-out prices you see are based on prices currently being quoted by the property for a 30-day window around your check-in date. To ', 'Powered By: ATRGWorld ', '2021Â©Copyright');
...
(72, 14, 'Address', 'Plot-7, Road-02, Hotel Motel Zone, Francisco Road, United States', '', NULL, NULL, NULL, NULL, 1, 0, 0, 0),
(73, 14, 'Phone & WhatsApp Number', '0892 555 983445', '', NULL, NULL, NULL, NULL, 1, 0, 0, 0),
(74, 14, 'Email', 'info@hotelthecoxtoday.com', '', NULL, NULL, NULL, NULL, 1, 0, 0, 0),
...
(1, NULL, NULL, NULL, 'admin@gmail.com', '21232f297a57a5a743894a0e4a801fc3', NULL, NULL, '2021-09-08 16:31:25', NULL, '::1', 1, 1);
...
--
ALTER TABLE `leave_type`
  MODIFY `leave_type_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `payroll_holiday`
  MODIFY `payrl_holi_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `roomfacilitytype`
  MODIFY `facilitytypeid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `tbl_floor`
  MODIFY `floorid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `tbl_floorplan`
--
ALTER TABLE `tbl_floorplan`
  MODIFY `floorplanid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=152;
...
--
ALTER TABLE `tbl_roomnofloorassign`
  MODIFY `roomassignid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=230;

--
-- AUTO_INCREMENT for table `tbl_room_offer`
--
ALTER TABLE `tbl_room_offer`
  MODIFY `offerid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
